...
| :--- | :--- | :--- | :--- |
| **⭐ NILAM Hybrid Assistant v1.0.4<br>(二合一双模融合版)** | • **Tab 选项卡紧凑界面**<br>• 默认 ⚡ **API 自动批量提交** (V2)<br>• 备用 📝 **DOM 辅助填表降级** (V1)<br>• 内置 **18,000 本华巫英巨量题库**<br>• 依账号 User ID 种子打乱防撞 | **【强烈推荐】**<br>兼顾极速提交与防封降级保障，适配各种屏幕尺寸不遮挡 | 👉 [**点击安装 v1.0.4 最新版**](https://raw.githubusercontent.com/cscLearn/nilam-assistant/main/tampermonkey/nilam-hybrid.user.js?v=1.0.4) |
